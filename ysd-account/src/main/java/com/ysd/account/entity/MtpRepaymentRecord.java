...
/**
 * 表名:mtp_repayment_record
 * 
 */
public class MtpRepaymentRecord extends BaseEntity {
    /**
     * 现提ID
     */
    private Integer id;
    ...
    /**
     * -1:废弃;0:新创建,未提交;1：已经提交;2:回盘成功3:回盘失败;
     */
    private Integer mtpRepaymentStatus;
     ...
     * 通联批量还款提交的流水号
     */
    private String allinSubmitTradeNo;
    ...
    public Integer getMtpRepaymentStatus() {
        return mtpRepaymentStatus;
    }

    public void setMtpRepaymentStatus(Integer mtpRepaymentStatus) {
        this.mtpRepaymentStatus = mtpRepaymentStatus;
    }
    ...
    public String getAllinSubmitTradeNo() {
        return allinSubmitTradeNo;
    }

    public void setAllinSubmitTradeNo(String allinSubmitTradeNo) {
        this.allinSubmitTradeNo = allinSubmitTradeNo;
    }
}