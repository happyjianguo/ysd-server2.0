...
import com.allinpay.xmltrans.service.OldTranxServiceImpl;
...
public class TranxMain {
	...
	public static void main(String[] args) throws Exception {
		...
		OldTranxServiceImpl tranxService=new OldTranxServiceImpl();
...
//		tranxService.downBills(testTranURL, isfront);
	...
	//	tranxService.downSimpleBills(testURLOfBill1, true);
		//交易查询
	 //  tranxService.queryTradeNew(testTranURL11, "20060400000044520161130003067", isfront,"","");
		...
		//单笔实时代收
	//tranxService.singleTranx(testTranURL11, trx_code, busicode,isfront);
		...
		//商户虚拟户历史余额查询
		//tranxService.merAcctBalance(testTranURL11,isfront,"20140805","20140806");
		
		//单笔实时身份验证
		//tranxService.singleAcctVerify(testTranURL11,isfront);
...
//		tranxService.batchAcctVerify(testTranURL, isfront);
	...
	//tranxService.acctBalance(testTranURL1, isfront, "20140805", "20140806");
		...
		//国民身份验证
//		tranxService.idVerify(testTranURL11, isfront);
...
//	tranxService.rnpQ(tranURL, isfront);
		...
		//tranxService.putmoney(testTranURL11, isfront);
		//ftp+xml
