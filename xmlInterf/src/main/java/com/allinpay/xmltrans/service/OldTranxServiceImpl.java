...
import com.allinpay.xmltrans.pojo.OldTranxCon;
...
@Deprecated
public class OldTranxServiceImpl {
	OldTranxCon tranxContants=new OldTranxCon();
...
//		VALBSUM.setTOTAL_SUM("200000");
	...
	public void idVerifyQ(String url,boolean isTLTFront) throws Exception {
		...
		vbreq.setQSN("200604000000445-1506218896559");
		vbreq.setQTARGET("1");
		aipgReq.addTrx(vbreq);
