...
//	private static String pathPfx="cert/20060400000044502.p12";
    ...
    private static String cerFile="/Users/xishengchun/git/ysd2.0/xsigntool/src/test/resources/cert/allinpay-pds.cer";
	private static String pathPfx="/Users/xishengchun/git/ysd2.0/xsigntool/src/test/resources/cert/20060400000044502.p12";
...
//    @Test
    public static String getPathPds() {
        String path = SignTest.class.getResource("/cert/allinpay-pds.cer").getPath();
//        System.out.println("path:" + path);
        return path;
    }

//    @Test
    public static String getPathP12() {
        String path = SignTest.class.getResource("/cert/20060400000044502.p12").getPath();
//        System.out.println("path:" + path);
        return path;
    }
