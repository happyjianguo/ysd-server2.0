...
public class AllinMTPConfig {
    ...
    public static String getSettlementAccount() {
        return AllinMTPConfig.getInstance().getProp("allin.settlement.account");
    }
     ...
     * @return
     */
    public static String getSettlementBank() {
        return AllinMTPConfig.getInstance().getProp("allin.settlement.bank");
    }
